...
<!--                   <li>
                 ...
                 <li><a class="nav-link" href="admin_manage.jsp">
                    ⏵ 예약 현황
                </a></li>
                  <li><a class="nav-link" href="admin_delete.jsp">
                    ⏵ 예약 취소
                </a></li>
                  <li><a class="nav-link" href="admin_modify.jsp">
                    ⏵ 예약 수정
                </a></li>
                  <li><a class="nav-link" href="admin_reservation.jsp">
                    ⏵ 예약 등록
                </a> </li>
                </ul>
                </div>
                ...
                <div class="container2">
                  ...
                  <table class="tg" width="850" height="-20" >
           	<%
			...
			String sql = "SELECT * FROM reservation WHERE date = date_format(NOW(),'%Y%m%d')";
		   	...
		   	int i = 0;
           	%>
                <table class="tg" width="800" height="50">
                ...
                <div class="container">
                    <div class="row">
                      <div class="col-12">
                        ...
                        <!-- Submit Button-->
                        <div class="btn"><button class="btn btn-primary btn-xl text-uppercase" style= "margin-left:650px; margin-top:20px" id="submitButton" type="submit" onClick="buttonClick()" >확인</button></div>
