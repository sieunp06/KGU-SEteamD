         ...
         String sql = "SELECT * FROM reservation WHERE user_id = ?";
            ...
            <thead>
              <tr>
                ...
                <td class="tg-uqo3" colspan="2">예약 삭제</td>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              <tr height="30" >
                ...
                <td class="tg-0lax" colspan="2"><input type="button"  style="margin-right: -50px; margin-left:25px; background:darkgray;"class="checkBtn" value="예약 삭제" /></td>
