...
<!--                   <li>
           	...
           	%>
                ...
                %>
                  ...
                  <tr height="30">
                    ...
                    <td class="tg-0lax" colspan="2"><input type="button" style="margin-left: 25px; margin-right:-15px"class="checkBtn" value="예약취소" /></td>
                  </tr>
	    ...
	    /* 		alert("클릭한 Row의 모든 데이터 : "+tr.text()); */
	    	...
	    	function passData(data){
	    		location.href = "admin_cancle.jsp?data="+data;
	    	}
        </script>
        </html>